...
def updata(data):
    ...
    client.execute(f"INSERT INTO alarm_hz_day_1 ( searching_datetime,enbid,cellid,eci,vendor,total_num,important_alarm_num,urgent_alarm_num,less_important_alarm_num,hint_alarm_num,top1_alarm_name,top1_alarm_num,top2_alarm_name,top2_alarm_num,top3_alarm_name,top3_alarm_num ) VALUES" , data,  types_check=True)
