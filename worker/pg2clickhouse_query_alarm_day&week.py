...
if __name__ == '__main__':
    ...
    insert_sql = """
        ...
        select {} from "{}".{}.{} where urgent_alarm_num is not null 
    """.format(table_name, ','.join(columns_list['column_name'].values), columns_type_list_4trino, db_name, schema_name,
               table_name)
