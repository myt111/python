...
def update_table(id): 
    ...
    update_lte_conn_cell_servtype = "update public.task_"+id+"_lte_conn_cell_servtype set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_conn_cell_servtype set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_conn = "update public.task_"+id+"_lte_conn set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_conn set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_ho_cell = "update public.task_"+id+"_lte_ho_cell set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_ho_cell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_ho_snbcell = "update public.task_"+id+"_lte_ho_snbcell set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_ho_snbcell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_hoout_snbcell = "update public.task_"+id+"_lte_hoout_snbcell set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_hoout_snbcell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_cell = "update public.task_"+id+"_lte_mr_cell set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_cell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_cell_total = "update public.task_"+id+"_lte_mr_cell_total set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_cell_total set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_grid = "update public.task_"+id+"_lte_mr_grid set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_grid set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_grid_cell = "update public.task_"+id+"_lte_mr_grid_cell set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_grid_cell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_grid_interfcell = "update public.task_"+id+"_lte_mr_grid_interfcell set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_grid_interfcell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_grid_snbcell = "update public.task_"+id+"_lte_mr_grid_snbcell set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_grid_snbcell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_grid_snbcell_total = "update public.task_"+id+"_lte_mr_grid_snbcell_total set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_grid_snbcell_total set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_overlaparea = "update public.task_"+id+"_lte_mr_overlaparea set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_overlaparea set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_poorcoveragearea = "update public.task_"+id+"_lte_mr_poorcoveragearea set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_poorcoveragearea set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_snbcell = "update public.task_"+id+"_lte_mr_snbcell set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_snbcell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_snbcell_total = "update public.task_"+id+"_lte_mr_snbcell_total set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_snbcell_total set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_mr_userconn = "update public.task_"+id+"_lte_mr_userconn set starttime =  starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_mr_userconn set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_snbcell_sum = "update public.task_"+id+"_lte_snbcell_sum set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;update public.task_"+id+"_lte_snbcell_sum set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; "
    update_lte_uuextend_cell = "update public.task_"+id+"_lte_uuextend_cell set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_uuextend_cell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_uuextend_cellhour = "update public.task_"+id+"_lte_uuextend_cellhour set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_uuextend_cellhour set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_uuextend_user = "update public.task_"+id+"_lte_uuextend_user set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_uuextend_user set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_uuextend_user_cell = "update public.task_"+id+"_lte_uuextend_user_cell set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_uuextend_user_cell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_uuextend_user_grid_snbcell_total = "update public.task_"+id+"_lte_uuextend_user_grid_snbcell_total set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_uuextend_user_grid_snbcell_total set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_uuextend_user_snbcell = "update public.task_"+id+"_lte_uuextend_user_snbcell set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_uuextend_user_snbcell set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000;"
    update_lte_uuextend_userconn = "update public.task_"+id+"_lte_uuextend_userconn set starttime = starttime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; update public.task_"+id+"_lte_uuextend_userconn set endtime =  endtime+86400*cast((cast(current_date as date) - '2022-06-16') as bigint)*1000; "


    sql = update_lte_conn_cell_servtype + update_lte_conn + update_lte_ho_cell + update_lte_ho_snbcell + \
          update_lte_hoout_snbcell + update_lte_mr_cell + update_lte_mr_cell_total + update_lte_mr_grid + update_lte_mr_grid_cell + \
          update_lte_mr_grid_interfcell + update_lte_mr_grid_snbcell + update_lte_mr_grid_snbcell_total + update_lte_mr_overlaparea + \
          update_lte_mr_poorcoveragearea + update_lte_mr_snbcell + update_lte_mr_snbcell_total + update_lte_mr_userconn + update_lte_snbcell_sum + \
          update_lte_uuextend_cell + update_lte_uuextend_cellhour + update_lte_uuextend_user + update_lte_uuextend_user_cell + \
          update_lte_uuextend_user_grid_snbcell_total + update_lte_uuextend_user_snbcell + update_lte_uuextend_userconn
...
def postgre_trace():
    ...
    # trace表格复制
    sql_insert_table = update_table(str(sk_task.iloc[0, 0]))
    cur.execute(sql_insert_table)
    conn.commit()
